// pages/highGradeMove/highGradeMove.js
//获取应用实例
var app = getApp()
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (value == 'car5') {
          ...
          carExplainBottom = '容量：可容纳体积5个立方';
        } else if (value == 'car7') {
          carExplainBottom = '容量：可容纳体积10个立方';
        } else if (value == 'car8') {
          carExplainBottom = '容量：可容纳体积20个立方';
        } else if (value == 'car9') {
          carExplainBottom = '容量：可容纳体积30个立方';
        } else if (value == 'car10') {
          carExplainBottom = '容量：可容纳体积40个立方';
        }
